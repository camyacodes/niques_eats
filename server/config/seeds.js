...
db.once("open", async () => {
	...
	const products = await Product.insertMany([
		// BRUNCH MAIN DISHES
		{
			...
			description:
				"Biscuit cheesecake jelly beans muffin dragée caramels macaroon. Cotton candy sugar plum I love carrot cake oat cake. Macaroon sugar plum cookie jelly I love I love bear claw sesame snaps.",
		...
		},
		{
			...
			description: "Ingredients: sausage, bacon, eggs, biscuit, cheese grits",
		...
		{
			name: "Sausage",
			description: "Turkey sausage grill to perfection.",
			image: "sausage.jpg",
			category: categories[1]._id,
			price: 4,
			quantity: 10,
